"""
HelpForStudyTelegramBot - A Telegram bot to assist users in studying by providing questions and flashcards.
This bot allows users to select a subject and study mode, providing them with questions or flashcards to help them prepare for exams.
    Copyright (C) 2025  Mattia Muraro
